...
<ul>
  <li>App disponivel na Play Store , e pode ser baixado pelo link a seguir ->
    <a style="display:flex; align-items: baseline, flex-direction: row;" height="200" width="auto" title="Controla Baba (Controla Partidas de Futebol)" href="https://play.google.com/store/apps/details?id=com.controlababa" rel="nofollow noopener" target="_blank">
